...
static struct hw_uart_device _uart_device0 =
{
    ...
    .rxmio = (rt_uint32_t*)ZynqMP_IOU_SLCR_MIO_PIN(34), /* MIO34 */
    .txmio = (rt_uint32_t*)ZynqMP_IOU_SLCR_MIO_PIN(35), /* MIO35 */
};
...
{
    .uart  = (UART_Registers*)XPAR_PSU_UART_1_BASEADDR,
    .irqno = XPAR_PSU_UART_1_INTR,
    .rxmio = (rt_uint32_t*)ZynqMP_IOU_SLCR_MIO_PIN(33), /* MIO33 */
    .txmio = (rt_uint32_t*)ZynqMP_IOU_SLCR_MIO_PIN(32), /* MIO32 */
};
